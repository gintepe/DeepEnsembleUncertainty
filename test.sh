...
# CUDA_VISIBLE_DEVICES=$CUDA python main.py --lr 1e-4 --batch-size 128 --epochs 40 --corrupted-test --model $MODEL --checkpoint --method ncensemble --n 3 --reg-weight 2.0 --reg-decay 1.0
...
# python main.py --lr 1e-4 --cpu --batch-size 128 --epochs 40 --model $MODEL --method ensemble --n 3 --corrupted-test
# python main.py --lr 1e-4 --cpu --batch-size 128 --epochs 20 --model $MODEL --method mcdrop --n 5 --corrupted-test
# python main.py --lr 1e-4 --cpu --batch-size 128 --epochs 20 --model $MODEL --method single --corrupted-test
