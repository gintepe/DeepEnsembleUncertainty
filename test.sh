...
# CUDA_VISIBLE_DEVICES=$CUDA python main.py --lr 1e-4 --batch-size 128 --epochs 40 --corrupted-test --model $MODEL --checkpoint --optimizer adam --method mcdrop --n 5 --dropout 0.5
...
# CUDA_VISIBLE_DEVICES=$CUDA python main.py --lr 1e-4 --batch-size 128 --epochs 40  --corrupted-test --model $MODEL --reg-weight 0.01 --checkpoint --optimizer adam --method moe --moe-type dense --moe-gating simple --n 5 --predict-gated
# CUDA_VISIBLE_DEVICES=$CUDA python main.py --lr 1e-4 --batch-size 128 --epochs 40  --corrupted-test --model $MODEL --reg-weight 0 --checkpoint --optimizer adam --method moe --moe-type dense --moe-gating simple --n 5 --predict-gated
# CUDA_VISIBLE_DEVICES=$CUDA python main.py --lr 1e-4 --batch-size 128 --epochs 40  --corrupted-test --model $MODEL --reg-weight 0.01 --checkpoint --optimizer adam --method moe --moe-type dense --moe-gating same --n 5 --predict-gated
# 
# CUDA_VISIBLE_DEVICES=$CUDA python main.py --lr 1e-4 --batch-size 128 --epochs 40  --corrupted-test --model $MODEL --dropout 0.1 --reg-weight 0 --checkpoint --optimizer adam --method moe --moe-type dense --moe-gating mcd_simple --n 5 
...
# CUDA_VISIBLE_DEVICES=$CUDA python main.py --lr 1e-4 --batch-size 128 --epochs 40  --corrupted-test --model $MODEL --checkpoint --optimizer adam --reg-weight 0.01 --method moe --moe-type dense --moe-gating conv --n 5 --predict-gated
